...
urlpatterns = [
    ...
    re_path(
        "forgot-password/$",
        views.hospital_forgot_password,
        name="hospital-forgot-password",
    ),
    ...
    re_path(
        "update-user-details/", views.update_user_details, name="update-user-details"
    ),
